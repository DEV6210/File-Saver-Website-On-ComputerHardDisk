...
<html>
    ...
    <body>
        <div class="main">
            ...
            Type:  <input type="radio" name="type" required id="sc">
            <label for="sc"> SC </label> 
            <input type="radio" name="type" required id="st"> 
            <label for="st"> ST </label>
            <input type="radio" name="type" required id="obc">
            <label for="obc"> OBC </label><br/><br/>
